...
const Toggle = ({ setToggleView, toggleView }: ToggleProps) => {
  ...
  const toggleStyles =
    "max-h-12 w-auto cursor-pointer text-black items-center flex px-2 my-3 border-2 bg-gray-300 hover:bg-gray-400 border-b-gray-500 border-l-gray-500 border-r-gray-100 border-t-gray-100";
